...
mySwiper2.on('slideChange', function () {
    ...
    console.log('Active slide changed*******88');
...
document.querySelectorAll('.fetch-tribute').forEach(button => {
  button.addEventListener('click', event => {
    ...
    button.querySelector('.reel-add-comment').style.display = 'none';
    console.log(button.querySelector('.reel-add-comment'));
...
document.querySelectorAll('.share-btn').forEach(button => {
  button.addEventListener('click', event => {
    ...
    var deceased_name = element_index.querySelector('.deceased-name').value;
     var deceased_id = element_index.querySelector('.player-photo-id').value;
    document.getElementById('share-container').querySelector('.share-deceased-name').textContent = `${deceased_name}'s Memorial`;
    var url = 'https://futurismx.pythonanywhere.com/create_biography';
