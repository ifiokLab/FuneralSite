...
mySwiper.on('slideChange', function () {
  ...
  if(element_index.classList.contains('event-photos')){
    ...
    let deceased_image = document.querySelector('.player-deceased-image').value;
    let deceased_name = document.querySelector('.player-deceased-name').value;
    let deceased_description = document.querySelector('.player-deceased-description').value;
    let deceased_music = document.querySelector('.player-deceased-music').value;
    console.log(deceased_music,deceased_image ,deceased_description);
    const music_list = [
        {
            img :deceased_image ,
            name : deceased_name,
